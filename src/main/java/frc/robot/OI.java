...
public class OI {
	...
	private static int NUMBER_OF_CONTROLLERS = Constants.ControllerConstants.NUMBER_OF_CONTROLLERS;
	private static double DEADZONE_VALUE = Constants.ControllerConstants.DEADZONE_VALUE;
	public OI() {
